...
/** Entry 12: Creating Condition.java class
 *  1.  This class intended to make a model of Condition data fetched from Dark Sky API and turns it into POJO
 *  2.  This class will be needed by the other dto weather classes thus it should be made first.
 *  3.  Looks like the class is simple field declarations which will be filled by JSON data from the external API
 *  4.  The it followed by standards getters and setters for all data field.
 *  */

@JsonIgnoreProperties(ignoreUnknown = true)//This class accepts JSON data with unknown is permissible
public class Condition extends Dto {
    //field declarations
    private Instant time; //Instant means one point of start and end of a time line
    private String summary;
    private String icon;
    private double nearestStormDistance;
    private double nearestStormBearing;
    private double percipIntensity;
    ...
    public double getPercipIntensity() {
        return percipIntensity;
    }

    public void setPercipIntensity(double percipIntensity) {
        this.percipIntensity = percipIntensity;
    }
    ...
    public void setPercipProbability(double percipProbability) {
